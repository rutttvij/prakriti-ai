...
async def create_report(
    ...
    """
    Create a waste report AND store AI classification snapshot.

    - Reads image bytes once
    - Saves file to disk
    - Runs classify_image_with_model(bytes)
    - Stores label + confidence + recyclable on the report
    """
